...
bool Adafruit_VL53L0X::begin ( void )
{
	int32_t status_int;
	int32_t init_done = 0;
	...
	pMyDevice->comms_type      =  VL53L0X_COMMS_I2C;
	...
	if ( VL53L0X_IMPLEMENTATION_VER_MAJOR != VERSION_REQUIRED_MAJOR ||
		...
		//RED_MAJOR) "." STR(VERSION_REQUIRED_MINOR) "." STR(VERSION_REQUIRED_BUILD)));
		return false;
	}
...
VL53L0X_Error Adafruit_VL53L0X::rangingTest ( VL53L0X_RangingMeasurementData_t *RangingMeasurementData, bool debug )
{
